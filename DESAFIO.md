# Teste de programação Spring Boot
...
Empresas de cartões e benefícios processam todos os dias diversas transações.
De forma breve, as transações saem das maquininhas de cartão e chegam até uma das aplicações do sistema, conhecida como *autorizador*, que realiza uma série de verificações e análises. Essas também são conhecidas como *regras de autorização*. 
